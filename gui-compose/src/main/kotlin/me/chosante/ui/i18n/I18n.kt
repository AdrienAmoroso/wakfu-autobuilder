...
enum class Tr(
    ...
    EDIT_SUBLIMATIONS("Add sublimation", "Ajouter une sublimation"),
    ...
    MANUAL_EQUIP_TITLE("Equip an item", "Équiper un objet"),
    MANUAL_EQUIP_ACTION("Equip", "Équiper"),
    MANUAL_UNEQUIP("Unequip", "Déséquiper"),
    NAV_MANUAL_BUILD("Build", "Construire"),
    MANUAL_BUILD_TITLE("Manual build", "Construction manuelle"),
    MANUAL_BUILD_SUBTITLE(
        "Pick each slot yourself, socket runes & sublimations, and allocate skill points by hand.",
        "Choisissez chaque emplacement vous-même, sertissez runes et sublimations, et répartissez les points de compétence à la main."
    ),
    MANUAL_SKILLS_TITLE("Skill points", "Points de compétence"),
    MANUAL_EMPTY_HINT("Click a slot to equip an item", "Cliquez sur un emplacement pour équiper un objet"),
    MANUAL_TAB_ITEMS("Items", "Objets"),
    MANUAL_TAB_ENCHANTMENT("Enchantment", "Enchantement"),
    MANUAL_TAB_APTITUDE("Aptitude", "Aptitude"),
    MANUAL_TAB_SPELLS("Spells", "Sorts"),
    MANUAL_TAB_NOTE("Note", "Note"),
    MANUAL_UNSAVED_BUILD("Unsaved build", "Build non enregistré"),
    MANUAL_NEW_BUILD("New", "Nouveau"),
    MANUAL_SIDEBAR_VITALS("Vitals", "Vitalité"),
    MANUAL_SIDEBAR_MASTERY_RESISTANCE("Mastery & Resistance", "Maîtrise et résistance"),
    MANUAL_SIDEBAR_COMBAT("Combat", "Combat"),
    MANUAL_SIDEBAR_SECONDARY("Secondary", "Secondaire"),
    MANUAL_TOTAL_MASTERY("Total mastery", "Maîtrise totale"),
    MANUAL_TOTAL_RESISTANCE("Total resistance", "Résistance totale"),
    MANUAL_ITEM_MIN_LEVEL("Min lvl", "Niv. min"),
    MANUAL_ITEM_MAX_LEVEL("Max lvl", "Niv. max"),
    MANUAL_RESET_FILTERS("Reset filters", "Réinitialiser les filtres"),
    MANUAL_NO_ITEMS_MATCH("No items match these filters", "Aucun objet ne correspond à ces filtres"),
    MANUAL_ITEM_MORE_STATS("+%d more", "+%d autres"),
    MANUAL_ENCHANT_MY_ITEMS("My items", "Mes objets"),
    MANUAL_ENCHANT_RUNES("Runes", "Chasses"),
    MANUAL_ENCHANT_SUBLIMATIONS("Sublimations", "Sublimations"),
    MANUAL_ENCHANT_ARMED_HINT("Click an item on the left to apply it", "Cliquez sur un objet à gauche pour l'appliquer"),
    MANUAL_ENCHANT_SEARCH_RUNES("Search runes…", "Rechercher des chasses…"),
    MANUAL_ENCHANT_SEARCH_SUBS("Search sublimations…", "Rechercher des sublimations…"),
    MANUAL_NOTE_PLACEHOLDER("Write anything you want to remember about this build…", "Notez tout ce que vous voulez retenir sur ce build…"),
    ...
    TOAST_INVALID_MANUAL_BUILD(
        "Can't equip that — it would make the build invalid",
        "Impossible d'équiper cet objet — le build deviendrait invalide"
    ),
    ...
    ITEM_SOURCES_TITLE("Obtained via", "Obtention"),
    ITEM_SOURCES_RECIPE("Crafted (%s, %d ingredients)", "Fabriqué (%s, %d ingrédients)"),
    ITEM_SOURCES_MONSTERS("Drops from: %s", "Butin de : %s"),
    ITEM_SOURCES_NODES("Harvested from: %s", "Récolté sur : %s"),
    ITEM_SOURCES_MORE("+%d more", "+%d autres"),
